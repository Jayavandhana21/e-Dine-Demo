  ...
  const students = [
    {
      id: 1,
      name: 'Ajmal',
      mail: 'Mohideen@lfsolutions.net',
      school: 'School 1'
    },
    {
      id : 2,
      name : 'Taism',
      mail : 'ajmal_cutty@yahoo.in',
      school : 'TEST K'
    },
    {
      id : 3,
    ...
    },
    {
      id : 4,
      name : 'Jack',
      mail : 'jack_son@yahoo.in',
      school : 'School 1'
    },
    {
      id : 5,
      name : 'Sam',
      mail : 'sam_funky@yahoo.in',
      school : 'School 1'
    },
    {
      id : 6,
      name : 'Emily',
      mail : 'emilygrace@yahoo.in',
      school : 'TEST K'
    },
    {
      id : 7,
      name : 'Harish',
      mail : 'harish4@gmail.com',
      school : 'School 1'
    }
  ]
  ...
  return (
    ...
    <div className='p-4'>
      <div className='grid grid-cols-12 justify-between font-bold mb-4 text-lg'>
        ...
        <button className='col-span-4 bg-blue-600 text-white p-5 rounded-[0rem_0.375rem_0.375rem_0rem]' onClick={handleClick1}>TopUp</button>
      </div>
      {
        students.map((student) => (
          <div key={student.id} className='grid grid-cols-12 gap-5 my-2 p-6 relative bg-gray-100 rounded-lg' >
            ...
            <button className='absolute right-3 top-4 text-md bg-transparent ' onClick={handleClick}>
              <img src={edit}/>
            </button>
