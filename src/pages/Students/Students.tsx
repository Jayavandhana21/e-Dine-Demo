...
const handleClick2 = () => {
  ...
  return (
    <div className='p-4'>
     ...
     <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 md:gap-5 md:px-14 '>
      {students.map((student) => (
        <div
          key={student.id} 
          onClick={() => setSelectedStudent }
          className="grid grid-cols-12 gap-5 md:py-12 my-2 p-6 relative bg-gray-100 rounded-md cursor-pointer md:m">
          <div className="md:hidden col-span-3 lg: flex items-end justify-center bg-neutral-300 rounded-md " onClick={handleClick2}>
            <img src={profile} alt="Profile" />
          </div>

          <div className="col-span-9 flex flex-col p-1 md:pb-4" onClick={handleClick2}>
