...
interface DishSize {
    size: string;  // The size name (e.g., "Small - 6”")
    price: string; // The price for this size (e.g., "SGD 8")
  }
...
const OrderScreenv2 = () => {
    ...
    const [selectedDish, setSelectedDish] = useState(null); // State to store selected dish details
            ...
            <div className="grid grid-cols-2 gap-4 my-4 pb-7">
                {dishes.map((item) => (
                    <div
                        ...
                        onClick={() => {
                            setSelectedDish(item); // Set selected dish data
                            setOpen(true); // Open the bottom sheet
                        }}>
                        <div>
                        ...
                        {selectedDish && (
                            <div className="px-4 overflow-y-auto">
                                ...
                                <button
                                    onClick={() => {
                                        setOpen(false);
                                        alert(`Added ${selectedSize} ${selectedDish.name} to the cart!`);
                                    }}
